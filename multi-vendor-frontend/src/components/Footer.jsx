        ...
        <footer className="backdrop-blur-md bg-white/10 border-t border-pink-300/30 shadow-2xl rounded-t-3xl mx-2 md:mx-8 mt-12 overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row justify-between items-center gap-10 md:gap-0">
                ...
                <div className="flex gap-6 text-3xl">
                    <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" title="Facebook" aria-label="Facebook" className="hover:scale-110 hover:brightness-125 transition-all">
                        <FacebookIcon />
                    </a>
                    <a href="https://x.com" target="_blank" rel="noopener noreferrer" title="X" aria-label="X" className="hover:scale-110 hover:brightness-125 transition-all">
                        <XIcon />
                    </a>
                    <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" title="Instagram" aria-label="Instagram" className="hover:scale-110 hover:brightness-125 transition-all">
                        <InstagramIcon />
                    </a>
                    <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" title="TikTok" aria-label="TikTok" className="hover:scale-110 hover:brightness-125 transition-all">
                        <TikTokIcon />
                    </a>
                </div>
            </div>
